      ...
      <CCol xs={12}>
        <CCard className='datascrapby shadow-lg p-3 mb-4 bg-body rounded'>
          ...
          <CCardBody>
            <CForm>
              <CRow className="mb-3">
                <CFormLabel htmlFor="inputProjectTitle" className="labelForm col-sm-2 col-form-label">Project Title</CFormLabel>
                <CCol sm={10} >
                <CFormInput className='formInput inputProjectTitle' type="text" id="inputProjectTitle"/>
                </CCol>
              </CRow>
              <CRow className="mb-3">
                <CFormLabel htmlFor="inputTextQuery" className="labelForm col-sm-2 col-form-label">Text Query</CFormLabel>
                <CCol sm={10} >
                  <CFormInput className='formInput inputTextQuery' type="text" id="inputTextQuery"/>
                </CCol>
              </CRow>
              <CRow className="mb-3">
                <CFormLabel htmlFor="inputTweetCount2" className="labelForm col-sm-2 col-form-label">Tweet Count</CFormLabel>
                <CCol sm={10} >
                  <CFormInput className='formInput inputTweetCount2' type="text" id="inputTweetCount2"/>
                </CCol>
              </CRow>
              <CRow className='mb-3'>
                <CFormLabel htmlFor="InputDateRange" className="labelForm col-sm-2 col-form-label">Date Range</CFormLabel>
                <CCol sm={10}>
                  <CDateRangePicker className='formInput' locale="en-US" />
                </CCol>
              </CRow>  
              <CButton className='btnSubmit' onClick={submitInput} type="submit">Submit</CButton>
            </CForm>
          </CCardBody>
        </CCard>
        ...
        <CCard className='progress-card display-none shadow-lg p-3 bg-body rounded'>
          ...
          <div className='done display-none'>
            <p className='text-look'>Data berhasil di scrapping <br/>Untuk melihat hasil bisa klik Lihat<br/>atau bisa melihatnya di page Data Visualization</p>
            <div>
              <CButton className='btnSubmit btnUlang' onClick={reset}>Ulang</CButton>
              <Link
